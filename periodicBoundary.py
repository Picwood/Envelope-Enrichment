...
class PeriodicBoundary_e:
   ...
   def __init__(self, RP1=None, RP2=None, RP3=None, set1=None, set2=None, set3=None):
      ...
      self.set2 = set2
      self.set3 = set3
      self.modelname = 'Model-1' #change to access the current model (viewport ?)
...
class createRVE:
   def __init__(self):
      part_name = ""
      os.system('RVE_gene_envelope.py')
...
class homo:
   def __init__(self):
      os.system('ht-PBC-integrated-import-mesh.py')
