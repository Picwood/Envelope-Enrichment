...
def findElemType(line):
    line = line.upper()
    re_elemType = re.compile(r'(TYPE\=\w*)')
    print(re_elemType.search(line))
...
def main_combine(file1,file2):
    ...
    subfolder_name = name
    filepath_env = os.path.join(working_folder, '%s-model.inp' %(name))
    print(filepath_env)
...
#add step for translation (check the coordinates)..
        ...
        #f.writelines('*Elset, elset=VOLUME1, instance=RVEplus-1\n')
        #elemVol1 = inp_data2.get_elem_from_set('Volume1')
        #for i in range(0, len(elemVol1), 16):
        #    row_elements = elemVol1[i:i+4]
        #    f.writelines(', '.join(map(str, row_elements))+'\n')
...
#file2 = 'C:/Users/Florian/Documents/Perso/Canada/Poly/3d models/Job-90/Job-90-VER.inp'
#file1 = 'C:/Users/Florian/Documents/Perso/Canada/Poly/3d models/Job-90/Job-90.inp'
